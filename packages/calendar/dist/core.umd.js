;(function (global, factory) {
  ...
  var img =
    "data:image/svg+xml,%3c%3fxml version='1.0' encoding='utf-8'%3f%3e%3c!-- Uploaded to: SVG Repo%2c www.svgrepo.com%2c Generator: SVG Repo Mixer Tools --%3e%3csvg width='800px' height='800px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M6 9L12 15L18 9' stroke='%23DED8E1' stroke-width='4' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/svg%3e"
  ...
  const setDateOfMonth = (dateString, date) => {
    dateString =
      dateString.slice(0, 8) + doubleDigit(date) + dateString.slice(10)
    return dateString
  }
  ...
  function MonthViewWeek({ week }) {
    ...
    const weekDays = week.map((day) => {
      ...
      if (
        !isSameMonth(day, toJSDate($app.datePickerState.datePickerDate.value))
      )
    ...
    const hasFocus = (weekDay) =>
      toDateString$1(weekDay.day) === $app.datePickerState.datePickerDate.value
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsxs('li', {
        ...
        children: [
          jsxRuntime.jsx('button', {
            className:
              'sx__date-picker__years-accordion__expand-button sx__ripple--wide',
            onClick: () => expand(year),
            children: year,
          }),
          isExpanded &&
  ...
  function YearsView({ setMonthView }) {
    ...
    const setNewDatePickerDate = (year, month) => {
      $app.datePickerState.datePickerDate.value = toDateString$1(
  ...
  function ForwardBackwardNavigation() {
    ...
    signals.useSignalEffect(() => {
      setLocalizedRange(
        `${getLocalizedDate($app.calendarState.range.value.start, $app.config.locale.value)} ${$app.translate('to')} ${getLocalizedDate($app.calendarState.range.value.end, $app.config.locale.value)}`
      )
    })
    ...
    hooks.useEffect(() => {
      ...
      if (headerContentLeftPrepend && headerContentLeftPrependId) {
        headerContentLeftPrepend(
          getElementByCCID(headerContentLeftPrependId),
          {}
        )
      }
      ...
      if (headerContentRightAppend) {
        headerContentRightAppend(
          getElementByCCID(headerContentRightAppendId),
          {}
        )
      }
    }, [])
  ...
  const createDatePickerState = (config, selectedDateParam) => {
    ...
    const datePickerDate = signals.signal(
      initialSelectedDate || currentDayDateString
    )
  ...
  const calendarDeDE = {
    ...
    'Link to 1 more event on {{date}}':
      'Link zu 1 weiteren Ereignis am {{date}}',
  }
  ...
  const calendarFrFR = {
    ...
    'Link to 1 more event on {{date}}':
      'Lien vers 1 autre événement le {{date}}',
  }
  ...
  const createCalendarState = (calendarConfig, timeUnitsImpl, selectedDate) => {
    ...
    const setRange = (date) => {
      ...
      if (
        newRange.start ===
          ((_a = range.value) === null || _a === void 0 ? void 0 : _a.start) &&
        newRange.end ===
          ((_b = range.value) === null || _b === void 0 ? void 0 : _b.end)
      )
        return
  ...
  class ConfigImpl {
    constructor(
      locale = DEFAULT_LOCALE,
      firstDayOfWeek = DEFAULT_FIRST_DAY_OF_WEEK,
      min = toDateString$1(new Date(1970, 0, 1)),
      max = toDateString$1(new Date(new Date().getFullYear() + 1, 11, 31)),
  ...
  const createDatePickerConfig = (config, dateSelectionCallback) => {
    ...
    return new ConfigBuilder()
      ...
      .withStyle(
        (_a = config.datePicker) === null || _a === void 0 ? void 0 : _a.style
      )
  ...
  function TimeGridDay({ calendarEvents, date }) {
    ...
    return jsxRuntime.jsx('div', {
      ...
      onMouseUp: handlePointerUp,
      onTouchEnd: handlePointerUp,
      children: eventsWithConcurrency.map((event) =>
        jsxRuntime.jsx(
          TimeGridEvent,
          {
            calendarEvent: event,
  ...
  function TimeAxis() {
    ...
    signals.useSignalEffect(() => {
      ...
      const pixelsPerHour =
        $app.config.weekOptions.value.gridHeight / hoursPerDay
      document.documentElement.style.setProperty(
        ...
        children: hours.map((hour) =>
          jsxRuntime.jsx('div', {
            ...
            children: jsxRuntime.jsx('span', {
              ...
              children: formatter.format(new Date(0, 0, 0, hour)),
            }),
          })
        ),
      }),
  ...
  function DateGridDay({ calendarEvents, date }) {
    return jsxRuntime.jsx('div', {
      ...
      children: Object.values(calendarEvents).map((event, index) => {
        if (event === DATE_GRID_BLOCKER || !event)
          return jsxRuntime.jsx('div', {
            className: 'sx__date-grid-cell',
            style: { gridRow: index + 1 },
          })
        return jsxRuntime.jsx(DateGridEvent, {
          calendarEvent: event,
          gridRow: index + 1,
        })
      }),
              ...
              children: jsxRuntime.jsxs('div', {
                ...
                children: [
                  ...
                  jsxRuntime.jsx('div', {
                    ...
                    children: Object.values(week).map((day) =>
                      jsxRuntime.jsx(
                        DateGridDay,
                        { date: day.date, calendarEvents: day.dateGridEvents },
                        day.date
                      )
                    ),
                  }),
            ...
            jsxRuntime.jsxs('div', {
              ...
              children: [
                ...
                Object.values(week).map((day) =>
                  jsxRuntime.jsx(
                    TimeGridDay,
                    { calendarEvents: day.timeGridEvents, date: day.date },
                    day.date
                  )
                ),
              ],
  ...
  const setRangeForMonth = (config) => {
    ...
    const monthForDate =
      config.timeUnitsImpl.getMonthWithTrailingAndLeadingDays(year, month)
    const newRangeEndDate = toDateString$1(
      ...
      children: [
        ...
        numberOfNonDisplayedEvents > 0
          ? jsxRuntime.jsx('button', {
              ...
              children: `+ ${numberOfNonDisplayedEvents} ${getEventTranslationSingularOrPlural(numberOfNonDisplayedEvents)}`,
            })
          : null,
      ],
    })
  ...
  function MonthAgendaDay({ day, isActive, setActiveDate }) {
    ...
    const handleClick = () => {
      ...
      ;(_b = (_a = $app.config.callbacks).onClickAgendaDate) === null ||
      _b === void 0
        ? void 0
        : _b.call(_a, day.date)
    }
    ...
    return jsxRuntime.jsxs('button', {
      ...
      onKeyDown: handleKeyDown,
      children: [
        jsxRuntime.jsx('div', { children: jsDate.getDate() }),
        jsxRuntime.jsx('div', {
  ...
  function MonthAgendaDayNames({ week }) {
    ...
    return jsxRuntime.jsx('div', {
      className: 'sx__month-agenda-day-names',
            ...
            MonthAgendaEvents,
            {
              events:
                ((_a = agendaMonth.weeks
                  ...
                  .find(
                    (day) =>
                      day.date === $app.datePickerState.selectedDate.value
                  )) === null || _a === void 0
                  ? void 0
                  : _a.events) || [],
            },
