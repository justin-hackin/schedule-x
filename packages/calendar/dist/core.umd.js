;(function (global, factory) {
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        factory(
          ...
          global.preactHooks,
          global.preactCompat,
          global.preactSignals
        ))
})(this, function (exports, preact, jsxRuntime, hooks, compat, signals) {
  'use strict'

  const AppContext$1 = preact.createContext({})

  var img =
    "data:image/svg+xml,%3c%3fxml version='1.0' encoding='utf-8'%3f%3e%3c!-- Uploaded to: SVG Repo%2c www.svgrepo.com%2c Generator: SVG Repo Mixer Tools --%3e%3csvg width='800px' height='800px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M6 9L12 15L18 9' stroke='%23B8B5B8' stroke-width='4' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/svg%3e"
  ...
  const isKeyEnterOrSpace = (keyboardEvent) =>
  ...
  function MonthViewHeader({ setYearsView }) {
    ...
    const [selectedDateMonthName, setSelectedDateMonthName] = hooks.useState(
      dateStringToLocalizedMonthName($app.datePickerState.datePickerDate.value)
    )
    const [datePickerYear, setDatePickerYear] = hooks.useState(
    ...
    hooks.useEffect(() => {
      setSelectedDateMonthName(
        dateStringToLocalizedMonthName(
          $app.datePickerState.datePickerDate.value
        )
      )
      ...
      children: jsxRuntime.jsxs('header', {
        ...
        children: [
          ...
          jsxRuntime.jsx('button', {
            type: 'button',
            className:
              'sx__button sx__date-picker__month-view-header__month-year',
  ...
  function TimeIcon({ strokeColor }) {
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsxs('svg', {
        ...
        children: [
          jsxRuntime.jsx('g', { id: 'SVGRepo_bgCarrier', 'stroke-width': '0' }),
          jsxRuntime.jsx('g', {
  ...
  class CalendarEventImpl {
    ...
    get _isSingleHybridDayTimed() {
      ...
      const startDate = dateFromDateTime(this.start.toString())
      const endDate = dateFromDateTime(this.end.toString())
      const endDateMinusOneDay = toDateString$1(
  ...
  const getTimeStamp = (
    ...
    if (
      ...
      ((_a = eventTime.start) === null || _a === void 0
        ? void 0
        : _a.toString()) !==
        ((_b = eventTime.end) === null || _b === void 0
          ? void 0
          : _b.toString())
    ) {
    ...
    if (
      calendarEvent._isSingleDayTimed &&
      ((_c = calendarEvent.start) === null || _c === void 0
        ? void 0
        : _c.toString()) ===
        ((_d = calendarEvent.end) === null || _d === void 0
          ? void 0
          : _d.toString())
    ) {
  ...
  function MonthView({ seatYearsView }) {
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsxs('div', {
        ...
        children: [
          jsxRuntime.jsx(MonthViewHeader, { setYearsView: seatYearsView }),
          jsxRuntime.jsx(DayNames, {}),
          month.map((week) => jsxRuntime.jsx(MonthViewWeek, { week: week })),
        ],
      }),
    })
  }
      ...
      children: jsxRuntime.jsxs('li', {
        ...
        children: [
          jsxRuntime.jsx('button', {
            type: 'button',
            className:
              'sx__button sx__date-picker__years-accordion__expand-button sx__ripple--wide',
            onClick: () => expand(year),
            children: year,
          }),
          isExpanded &&
            jsxRuntime.jsx('div', {
              ...
              children: yearWithDates.map((month) =>
                jsxRuntime.jsx('button', {
                  type: 'button',
                  className:
                    'sx__button sx__date-picker__years-view-accordion__month',
  ...
  function YearsView({ setMonthView }) {
    ...
    hooks.useEffect(() => {
      var _a
      const initiallyExpandedYear =
        (_a = document.querySelector('.sx__date-picker__years-view')) ===
          null || _a === void 0
          ? void 0
          : _a.querySelector('.sx__is-expanded')
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsx('ul', {
        ...
        children: years.map((year) =>
          jsxRuntime.jsx(YearsViewAccordion, {
            year: year,
  ...
  const getScrollableParents = (el, acc = []) => {
    ...
    return getScrollableParents(
      el.assignedSlot ? el.assignedSlot.parentNode : el.parentNode,
      acc
    )
  }
  ...
  function AppPopup({ wrapperEl }) {
    const $app = hooks.useContext(AppContext$1)
    const [datePickerView, setDatePickerView] = hooks.useState(
    ...
    const getFixedPositionStyles = () => {
      ...
      const inputRect =
        inputWrapperEl === null || inputWrapperEl === void 0
          ? void 0
          : inputWrapperEl.getBoundingClientRect()
    ...
    const [fixedPositionStyle, setFixedPositionStyle] = hooks.useState(
      ...
      children: jsxRuntime.jsx('div', {
        ...
        children:
          datePickerView === DatePickerView.MONTH_DAYS
            ? jsxRuntime.jsx(MonthView, {
                seatYearsView: () => setDatePickerView(DatePickerView.YEARS),
              })
            : jsxRuntime.jsx(YearsView, {
                setMonthView: () =>
                  setDatePickerView(DatePickerView.MONTH_DAYS),
              }),
      }),
    })
  }
  ...
  function AppWrapper({ $app }) {
    ...
    hooks.useEffect(() => {
      ...
      if (
        (_a = $app.config.style) === null || _a === void 0
          ? void 0
          : _a.fullWidth
      )
      ...
      $app.datePickerState.isDark.value,
      $app.datePickerState.isDisabled.value,
    ])
    let appPopupJSX = jsxRuntime.jsx(AppPopup, {
      wrapperEl: elementRef.current,
    })
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsx('div', {
        ref: elementRef,
        className: classList.join(' '),
        children: jsxRuntime.jsxs(AppContext$1.Provider, {
          value: $app,
          children: [
            jsxRuntime.jsx(AppInput, {}),
  ...
  function ViewSelection() {
    ...
    const handleSelectedViewKeyDown = (keyboardEvent) => {
      ...
      setTimeout(() => {
        var _a
        const allOptions =
          (_a = $app.elements.calendarWrapper) === null || _a === void 0
            ? void 0
            : _a.querySelectorAll('.sx__view-selection-item')
  ...
  function ForwardBackwardNavigation() {
    ...
    signals.useSignalEffect(() => {
      setLocalizedRange(
        `${getLocalizedDate$1($app.calendarState.range.value.start, $app.config.locale.value)} ${$app.translate('to')} ${getLocalizedDate$1($app.calendarState.range.value.end, $app.config.locale.value)}`
      )
    })
        ...
        children: [
          jsxRuntime.jsx(Chevron, {
            disabled: !!(
              ...
              dateFromDateTime(
                (_a =
                  rangeEndMinusOneRange === null ||
                  rangeEndMinusOneRange === void 0
                    ? void 0
                    : rangeEndMinusOneRange.toString()) !== null &&
                  _a !== void 0
                  ? _a
                  : ''
   ...
   * */
  const getElementByCCID = (customComponentId) =>
    document.querySelector(`[data-ccid="${customComponentId}"]`)
  ...
  class PreactView {
    ...
    render(onElement, $app) {
      preact.render(
        preact.createElement(this.Component, { $app, id: this.randomId }),
        onElement
      )
    }
    destroy() {
  ...
  function TimeGridEvent({
    ...
    const handleStartDrag = (uiEvent) => {
      ...
      if (
        (_a = calendarEvent._options) === null || _a === void 0
          ? void 0
          : _a.disableDND
      )
        return
    ...
    hooks.useEffect(() => {
      ...
      return () => {
        var _a, _b
        ;(_b = (_a = $app.config)._destroyCustomComponentInstance) === null ||
        _b === void 0
          ? void 0
          : _b.call(_a, customComponentId.current)
      }
    ...
    const hasCustomContent =
      (_b = calendarEvent._customContent) === null || _b === void 0
        ? void 0
        : _b.timeGrid
    ...
    const relativeStartWithinDayBoundary = realStartIsBeforeDayBoundaryStart
      ? dayBoundariesDateTime === null || dayBoundariesDateTime === void 0
        ? void 0
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [
        jsxRuntime.jsx('div', {
          ref: eventRef,
          id: isCopy
            ? getTimeGridEventCopyElementId(calendarEvent.id)
            : undefined,
          ...
          children: jsxRuntime.jsxs('div', {
            ...
            children: [
                  ...
                  children: [
                    ...
                    calendarEvent.location &&
                      jsxRuntime.jsxs('div', {
                        ...
                        children: [
                          jsxRuntime.jsx(LocationPinIcon, {
                            strokeColor: eventCSSVariables.iconStroke,
                          }),
                          calendarEvent.location,
                        ],
              ...
              hasCustomContent &&
                jsxRuntime.jsx('div', {
                  dangerouslySetInnerHTML: {
                    __html:
                      ((_c = calendarEvent._customContent) === null ||
                      _c === void 0
                        ? void 0
                        : _c.timeGrid) || '',
                  },
              ...
              $app.config.plugins.resize &&
                !((_d = calendarEvent._options) === null || _d === void 0
                  ? void 0
                  : _d.disableResize) &&
                jsxRuntime.jsx('div', {
  ...
  const isEvent0Minutes = (e) => {
    return (
      (e === null || e === void 0 ? void 0 : e.start) instanceof
        Temporal.ZonedDateTime &&
      (e === null || e === void 0 ? void 0 : e.end) instanceof
        Temporal.ZonedDateTime &&
  ...
  const areEvents0MinutesAndConcurrent = (e1, e2) => {
    return (
      isEvent0Minutes(e1) &&
      isEvent0Minutes(e2) &&
      (e1 === null || e1 === void 0 ? void 0 : e1.start) instanceof
        Temporal.ZonedDateTime &&
      (e2 === null || e2 === void 0 ? void 0 : e2.start) instanceof
        Temporal.ZonedDateTime &&
      areSameMinute(e1.start, e2.start)
    )
  }

  const handleEventConcurrency = (
    sortedEvents,
    ...
    for (let i = currentIndex; i < sortedEvents.length; i++) {
      ...
      if (
        ...
        (!nextEvent ||
          (concurrentEventsCache.every(
            (e) => e.end.epochNanoseconds <= nextEvent.start.epochNanoseconds
          ) &&
        ...
        for (let ii = 0; ii < concurrentEventsCache.length; ii++) {
          ...
          timePoints.sort(
            (a, b) =>
              a.time.localeCompare(b.time) || (a.type === 'end' ? -1 : 1)
          )
      ...
      if (
        (nextEvent &&
          event.end.epochNanoseconds > nextEvent.start.epochNanoseconds) ||
        concurrentEventsCache.some(
          (e) => e.end.epochNanoseconds > event.start.epochNanoseconds
        ) ||
        areBothEventsZeroMinutes
      ) {
        concurrentEventsCache.push(event)
      ...
      children: [
        backgroundEvents.map((event) =>
          jsxRuntime.jsx(jsxRuntime.Fragment, {
            children: jsxRuntime.jsx(TimeGridBackgroundEvent, {
  ...
  function TimeAxis() {
    const $app = hooks.useContext(AppContext)
    const [gridSteps, setGridSteps] = hooks.useState([])
    signals.useSignalEffect(() => {
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsx('div', {
        ...
        children: gridSteps.map((gridStep, index) =>
          jsxRuntime.jsxs('div', {
            className: 'sx__week-grid__hour',
            children: [
              hourCustomComponentFn &&
                hourCCIDs.length &&
                jsxRuntime.jsx('div', { 'data-ccid': hourCCIDs[index] }),
              !hourCustomComponentFn &&
                jsxRuntime.jsx('span', {
  ...
  function DateAxis({ week }) {
    ...
    const weekGridDateCCIDs = hooks.useState(() =>
      Array.from(
        { length: 7 },
  ...
  const positionInTimeGrid = (timeGridEvents, week, $app) => {
    ...
    for (const event of timeGridEvents) {
      ...
      if (
        event.start.epochNanoseconds >= range.start.epochNanoseconds &&
        event.end.epochNanoseconds <= range.end.epochNanoseconds
      ) {
        ...
        ;(_a = week[date]) === null || _a === void 0
          ? void 0
          : _a.timeGridEvents.push(event)
      }
    }
    return week
  }
  ...
  const getWidthToSubtract = (
    hasOverflowLeft,
    hasOverflowRight,
    enableOverflowSubtraction
  ) => {
  ...
  const getBorderRadius = (
    ...
    return {
      ...
      borderBottomRightRadius:
        hasOverflowRight || forceZeroRule ? 0 : undefined,
  ...
  function DateGridEvent({ calendarEvent, gridRow, isCopy }) {
    ...
    const customComponentId = hooks.useRef(
      customComponent
    ...
    const startResize = (mouseEvent) => {
      ...
      const eventCopy = deepCloneEvent(calendarEvent, $app)
      updateCopy(eventCopy)
      $app.config.plugins.resize.createDateGridEventResizer(
        eventCopy,
        updateCopy,
        mouseEvent
      )
      ...
      children: [
        ...
        Object.values(calendarEvents).map((event, index) => {
          ...
          return jsxRuntime.jsx(
            DateGridEvent,
            { calendarEvent: event, gridRow: index + 1 },
  ...
  const WeekWrapper = ({ $app, id }) => {
    ...
    const week = signals.useComputed(() => {
      var _a, _b
      const rangeStart =
        (_a = $app.calendarState.range.value) === null || _a === void 0
          ? void 0
          : _a.start
      const rangeEnd =
        (_b = $app.calendarState.range.value) === null || _b === void 0
          ? void 0
          : _b.end
              ...
              children: jsxRuntime.jsxs('div', {
                ...
                children: [
                  ...
                  jsxRuntime.jsx('div', {
                    ...
                    children: Object.values(week.value).map((day) =>
                      jsxRuntime.jsx(
                        DateGridDay,
                        {
                          date: day.date,
                  ...
                  jsxRuntime.jsx('div', {
                    className: 'sx__week-header-border',
                  }),
                ],
              }),
            }),
  ...
  const setRangeForMonth = (config) => {
    const monthForDate =
      config.timeUnitsImpl.getMonthWithTrailingAndLeadingDays(
        config.date.year,
        config.date.month
      )
    return {
  ...
  const getWeekNumber = (d, firstDayOfWeek) => {
    ...
    const nextYearStartOffset =
      (nextYearStart.dayOfWeek - firstDayOfWeek + 7) % 7
  ...
  function CalendarHeader() {
    ...
    const headerContentId = hooks.useState(
    ...
    const headerContentLeftPrependId = hooks.useState(
    ...
    const headerContentLeftAppendId = hooks.useState(
    ...
    const headerContentRightPrependId = hooks.useState(
    ...
    const headerContentRightAppendId = hooks.useState(
    ...
    const isDayOrWeekView = hooks.useMemo(() => {
      return [viewWeek.name, viewDay.name].includes(
            ...
            jsxRuntime.jsxs('div', {
              ...
              children: [
                headerContentLeftPrependId &&
                  jsxRuntime.jsx('div', {
                    'data-ccid': headerContentLeftPrependId,
                  }),
                jsxRuntime.jsx(TodayButton, {}),
                jsxRuntime.jsx(ForwardBackwardNavigation, {}),
                jsxRuntime.jsx(RangeHeading, {}, $app.config.locale.value),
                $app.config.showWeekNumbers.value &&
                  isDayOrWeekView &&
                  jsxRuntime.jsx(WeekNumber, {}),
                headerContentLeftAppendId &&
                  jsxRuntime.jsx('div', {
                    'data-ccid': headerContentLeftAppendId,
                  }),
              ],
            }),
            jsxRuntime.jsxs('div', {
              ...
              children: [
                headerContentRightPrependId &&
                  jsxRuntime.jsx('div', {
                    'data-ccid': headerContentRightPrependId,
                  }),
                $app.config.plugins.timezoneSelect &&
                  $app.config.plugins.timezoneSelect.isEnabled.value &&
                  jsxRuntime.jsx(
                    $app.config.plugins.timezoneSelect.ComponentFn,
                    { $app: $app }
                  ),
                $app.config.views.value.length > 1 &&
                  jsxRuntime.jsx(
                    ViewSelection,
                    {},
                    keyForRerenderingOnLocaleChange + '-view-selection'
                  ),
                jsxRuntime.jsx(AppWrapper, { $app: datePickerAppSingleton }),
                headerContentRightAppendId &&
                  jsxRuntime.jsx('div', {
                    'data-ccid': headerContentRightAppendId,
                  }),
              ],
            }),
          ],
  ...
  function useFetchEvents($app) {
    const hasCalledFetchEventsOnRenderRef = hooks.useRef(false)
    const initialRangeRef = hooks.useRef(
      rangeToString($app.calendarState.range.value)
    )
    const fetchAndSetEvents = async () => {
      var _a
      if (
        !((_a = $app.config.callbacks) === null || _a === void 0
          ? void 0
          : _a.fetchEvents) ||
        !$app.calendarState.range.value
      ) {
  ...
  function CalendarWrapper({ $app }) {
    ...
    signals.useSignalEffect(() => {
      ...
      if (
        ...
        !viewElement ||
        newView.name ===
          (currentView === null || currentView === void 0
            ? void 0
            : currentView.name)
      )
        return
    ...
    signals.useSignalEffect(() => {
      ...
      const newRangeStartIsLaterThanPrevious =
        (((_a = $app.calendarState.range.value) === null || _a === void 0
          ? void 0
          : _a.start.toString()) || '') > previousRangeStart
      // Use requestAnimationFrame to ensure smooth animation timing
      requestAnimationFrame(() => {
        setTransitionClass(
          newRangeStartIsLaterThanPrevious
            ? 'sx__slide-left'
            : 'sx__slide-right'
        )
        setTimeout(() => {
    ...
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: jsxRuntime.jsx('div', {
        ...
        children: jsxRuntime.jsx('div', {
          ...
          children: jsxRuntime.jsxs(AppContext.Provider, {
            value: $app,
            children: [
              jsxRuntime.jsx(CalendarHeader, {}),
              jsxRuntime.jsx('div', {
              ...
              $app.config.plugins.eventModal &&
                ...
                jsxRuntime.jsx(
                  ...
                  { $app: $app },
                  (_a = $app.config.plugins.eventModal.calendarEvent.value) ===
                    null || _a === void 0
                    ? void 0
                    : _a.id
                ),
  ...
  class CalendarApp {
    ...
    render(el) {
      ...
      preact.render(
        preact.createElement(CalendarWrapper, { $app: this.$app }),
        el
      )
    }
    destroy() {
  ...
  class CalendarAppSingletonImpl {
    constructor(
      ...
      datePickerConfig,
      calendarEvents,
      elements = { calendarWrapper: undefined }
    ) {
      Object.defineProperty(this, 'config', {
        enumerable: true,
        configurable: true,
  ...
  const createDatePickerState = (config, selectedDateParam) => {
    ...
    const isDark = signals.signal(
      ((_a = config.style) === null || _a === void 0 ? void 0 : _a.dark) ||
        false
    )
    const inputDisplayedValue = signals.signal(
    ...
    signals.effect(() => {
      var _a
      if (
        (_a = config.listeners) === null || _a === void 0 ? void 0 : _a.onChange
      )
  ...
  const calendarSvSE = {
    ...
    'Link to 1 more event on {{date}}':
      'Länk till 1 händelse till den {{date}}',
    CW: 'Vecka {{week}}',
  }
  ...
  const calendarDaDK = {
    ...
    'Link to 1 more event on {{date}}':
      'Link til 1 mere begivenhed den {{date}}',
    CW: 'Uge {{week}}',
    View: 'Visning',
  }
  ...
  const calendarNlNL = {
    ...
    'Link to 1 more event on {{date}}':
      'Link naar 1 meer evenement op {{date}}',
    CW: 'Week {{week}}',
    View: 'Weergave',
  }
  ...
  const calendarSkSK = {
    ...
    'Link to 1 more event on {{date}}':
      'Odkaz na 1 ďalšiu udalosť dňa {{date}}',
    CW: '{{week}}. týždeň',
    View: 'Zobrazenie',
  }
  ...
  const calendarTrTR = {
    ...
    'Link to 1 more event on {{date}}':
      '{{date}} tarihinde 1 etkinliğe bağlantı',
    CW: '{{week}}. Hafta',
    View: 'Görünüm',
  }
  ...
  const calendarIdID = {
    ...
    'Link to 1 more event on {{date}}':
      'Tautan ke 1 acara lainnya pada {{date}}',
    CW: 'Minggu {{week}}',
    View: 'Tampilan',
  }
  ...
  const calendarCaES = {
    ...
    'Link to 1 more event on {{date}}':
      'Enllaç a 1 esdeveniment més el {{date}}',
    CW: 'Setmana {{week}}',
    View: 'Vista',
  }
  ...
  const calendarHrHR = {
    ...
    'Link to {{n}} more events on {{date}}':
      'Link do još {{n}} događaja na {{date}}',
    'Link to 1 more event on {{date}}':
      'Link do još jednog događaja na {{date}}',
    CW: '{{week}}. tjedan',
    View: 'Pregled',
  }
  ...
  const createCalendarState = (calendarConfig, timeUnitsImpl, selectedDate) => {
    var _a
    const _view = signals.signal(
      ((_a = calendarConfig.views.value.find(
        (view) => view.name === calendarConfig.defaultView
      )) === null || _a === void 0
        ? void 0
        : _a.name) || calendarConfig.views.value[0].name
    )
    ...
    let wasInitialized = false
    let lastRangeEmitted__NEEDED_TO_PREVENT_RECURSION_IN_EVENT_RECURRENCE_PACKAGE_WHICH_CAUSES_RANGE_TO_UPDATE_AND_THUS_CAUSES_A_CYCLE =
      null
    const callOnRangeUpdate = (_range) => {
      ...
      if (
        (lastRange === null || lastRange === void 0
          ? void 0
      ...
      Object.values(calendarConfig.plugins || {}).forEach((plugin) => {
        ...
        ;(_a =
          plugin === null || plugin === void 0
            ? void 0
            : plugin.onRangeUpdate) === null || _a === void 0
          ? void 0
          : _a.call(plugin, _range.value)
        lastRangeEmitted__NEEDED_TO_PREVENT_RECURSION_IN_EVENT_RECURRENCE_PACKAGE_WHICH_CAUSES_RANGE_TO_UPDATE_AND_THUS_CAUSES_A_CYCLE =
          _range.value
      })
    }
    ...
    const setRange = (date) => {
      ...
      if (
        newRange.start.toString() ===
          ((_a = range.value) === null || _a === void 0
            ? void 0
            : _a.start.toString()) &&
        newRange.end.toString() ===
          ((_b = range.value) === null || _b === void 0
            ? void 0
            : _b.end.toString())
      )
        return
  ...
  class CalendarConfigImpl {
    constructor(
      ...
      views = [],
      dayBoundaries = DEFAULT_DAY_BOUNDARIES,
      weekOptions,
      calendars = {},
      plugins = {},
      isDark = false,
  ...
  class CalendarConfigBuilder {
    ...
    withWeekOptions(userDefinedWeekOptions) {
      ...
      if (
        ...
        (userDefinedWeekOptions === null || userDefinedWeekOptions === void 0
          ? void 0
  ...
  const createDatePickerConfig = (config, dateSelectionCallback) => {
    ...
    let teleportTo
    if (
      (_a = config.datePicker) === null || _a === void 0
        ? void 0
        : _a.teleportTo
    ) {
    ...
    return new ConfigBuilder()
      ...
      .withTeleportTo(teleportTo)
      .withStyle(
        (_b = config.datePicker) === null || _b === void 0 ? void 0 : _b.style
      )
  ...
  const createDateSelectionCallback = (calendarState, config) => {
    ...
    return (date) => {
      ...
      if (
        ((_a = config.callbacks) === null || _a === void 0
          ? void 0
          : _a.onSelectedDateUpdate) &&
        date.toString() !==
          (lastEmittedDate === null || lastEmittedDate === void 0
            ? void 0
            : lastEmittedDate.toString())
      ) {
  ...
  const validateConfig = (config) => {
    ...
    if (
      typeof ((_a = config.weekOptions) === null || _a === void 0
        ? void 0
        : _a.gridHeight) !== 'undefined' &&
    ...
    if (
      typeof ((_b = config.weekOptions) === null || _b === void 0
        ? void 0
        : _b.nDays) !== 'undefined' &&
    ...
    if (
      typeof ((_c = config.weekOptions) === null || _c === void 0
        ? void 0
        : _c.eventWidth) !== 'undefined' &&
    ...
    if (
      typeof ((_d = config.monthGridOptions) === null || _d === void 0
        ? void 0
        : _d.nEventsPerDay) !== 'undefined' &&
  ...
  const createCalendarAppSingleton = (config, plugins) => {
    ...
    const datePickerConfig = createDatePickerConfig(config, (date) =>
  ...
  function MonthGridEvent({
    ...
    if (
      (_c = calendarEvent._options) === null || _c === void 0
        ? void 0
        : _c.additionalClasses
    ) {
      classNames.push(...calendarEvent._options.additionalClasses)
    }
    if (wasEventAddedInLastSecond(calendarEvent))
    ...
    const hasCustomContent =
      (_d = calendarEvent._customContent) === null || _d === void 0
        ? void 0
        : _d.monthGrid
    return jsxRuntime.jsxs('div', {
      ...
      children: [
        ...
        hasCustomContent &&
          jsxRuntime.jsx('div', {
            dangerouslySetInnerHTML: {
              __html:
                ((_e = calendarEvent._customContent) === null || _e === void 0
                  ? void 0
                  : _e.monthGrid) || '',
            },
          }),
  ...
  function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
    ...
    const monthGridDayNameCCID = hooks.useState(
    ...
    return jsxRuntime.jsxs('div', {
      ...
      onDblClick: (e) => {
        var _a, _b
        return (_b = (_a = $app.config.callbacks).onDoubleClickDate) === null ||
          _b === void 0
          ? void 0
          : _b.call(_a, day.date, e)
      },
      onMouseDown: handleMouseDown,
      children: [
        fullDayBackgroundEvent &&
        ...
        jsxRuntime.jsxs('div', {
          ...
          children: [
            isFirstWeek
              ? jsxRuntime.jsx(jsxRuntime.Fragment, {
                  children: monthGridDayNameCustomComponent
                    ? jsxRuntime.jsx('div', {
                        'data-ccid': monthGridDayNameCCID,
                      })
                    : jsxRuntime.jsx('div', {
                        className: 'sx__month-grid-day__header-day-name',
                        children: getDayNameShort(
                          dayDate,
                          $app.config.locale.value
                        ),
                      }),
              ...
              : null,
            monthGridDateCCID
              ? jsxRuntime.jsx('div', { 'data-ccid': monthGridDateCCID })
              : jsxRuntime.jsx('div', {
        ...
        jsxRuntime.jsx('div', {
          ...
          children: Object.values(day.events)
            ...
            .map((event, index) => {
              ...
              return jsxRuntime.jsx(MonthGridEvent, {
                gridRow: index + 1,
                calendarEvent: event,
        ...
        numberOfNonDisplayedEvents > 0
          ? jsxRuntime.jsx('button', {
              type: 'button',
              className:
                'sx__button sx__month-grid-day__events-more sx__ripple--wide',
    ...
    return jsxRuntime.jsxs('div', {
      ...
      children: [
        ...
        week.map((day) => {
          ...
          return jsxRuntime.jsx(
            MonthGridDay,
            { day: day, isFirstWeek: isFirstWeek, isLastWeek: isLastWeek },
  ...
  function MonthAgendaDay({ day, isActive, setActiveDate }) {
    ...
    return jsxRuntime.jsxs('button', {
      ...
      onKeyDown: handleKeyDown,
      children: [
        jsxRuntime.jsx('div', { children: day.date.day }),
        jsxRuntime.jsx('div', {
          className: 'sx__month-agenda-day__event-icons',
          children: day.events.slice(0, 3).map((event) =>
            jsxRuntime.jsx('div', {
  ...
  function MonthAgendaDayNames({ week }) {
    ...
    return jsxRuntime.jsx('div', {
      ...
      children: localizedShortDayNames.map((oneLetterDayName) =>
        jsxRuntime.jsx('div', {
  ...
  function MonthAgendaEvent({ calendarEvent }) {
    ...
    const hasCustomContent =
      (_a = calendarEvent._customContent) === null || _a === void 0
        ? void 0
        : _a.monthAgenda
        ...
        !customComponent &&
          ...
          jsxRuntime.jsxs(preact.Fragment, {
            children: [
              ...
              jsxRuntime.jsxs('div', {
                className:
                  'sx__month-agenda-event__time sx__month-agenda-event__has-icon',
                children: [
                  jsxRuntime.jsx(TimeIcon, {
  ...
  function MonthAgendaEvents({ events }) {
    ...
    return jsxRuntime.jsx('div', {
      ...
      children: events.length
        ? events.map((event) =>
            jsxRuntime.jsx(MonthAgendaEvent, { calendarEvent: event }, event.id)
          )
        : jsxRuntime.jsx('div', {
  ...
  const MonthAgendaWrapper = ({ $app, id }) => {
    ...
    return jsxRuntime.jsx(AppContext.Provider, {
      ...
      children: jsxRuntime.jsxs('div', {
        ...
        children: [
          jsxRuntime.jsx(MonthAgendaDayNames, { week: agendaMonth.weeks[0] }),
          jsxRuntime.jsx('div', {
  ...
  const hasInfiniteRecurringEvents = (events) => {
    ...
    return events.some((event) => {
      ...
      const rrule =
        (_a = event._getForeignProperties()) === null || _a === void 0
          ? void 0
          : _a.rrule
   ...
   */
  const expandInfiniteRecurringEventsIfNeeded = ({
    $app,
    wrapperRef,
    filteredEvents,
    lastRangeExpansionRef,
   ...
   */
  const checkAndExpandInfiniteRecurringEvents = ({
    $app,
    wrapperRef,
    filteredEvents,
    visibleDates,
      ...
      return jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [
          jsxRuntime.jsx('div', {
            ...
            children: startLocaleString,
          }),
          endLocaleString &&
            jsxRuntime.jsx('div', {
              className: 'sx__list-event-end-time',
              children: endLocaleString,
            }),
        ],
      })
    }
  ...
  function ListEvent({
    ...
    if (
      (_b = calendarEvent._options) === null || _b === void 0
        ? void 0
        : _b.additionalClasses
    ) {
      classNames.push(...calendarEvent._options.additionalClasses)
    }
    return jsxRuntime.jsxs('div', {
      ...
      children: [
              ...
              jsxRuntime.jsxs('div', {
                ...
                children: [
                  ...
                  jsxRuntime.jsx('div', {
                    ...
                    children: jsxRuntime.jsx(EventTimes, {
                      ...eventInstanceInfo,
                    }),
                  }),
                ],
        ...
        hasCustomContent &&
          jsxRuntime.jsx('div', {
            dangerouslySetInnerHTML: {
              __html:
                ((_c = calendarEvent._customContent) === null || _c === void 0
                  ? void 0
                  : _c.listEvent) || '',
            },
          }),
  ...
  const getEventInstanceInfo = (event, forDayOf, locale, timeZone) => {
  ...
  const ListWrapper = ({ $app, id }) => {
    ...
    const listNoEventsCCID = hooks.useRef(
      listNoEventsCustomComponentFn
        ? 'custom-list-no-events-' + randomStringId()
        : undefined
    )
    const dayHeaderCCIDsRef = hooks.useRef({})
    /**
    ...
    const lastRangeExpansionRef = hooks.useRef(null)
    const isExpandingRangeRef = hooks.useRef(false)
    const scrollPositionBeforeExpansionRef = hooks.useRef(null)
    ...
    hooks.useEffect(() => {
      ...
      return () => {
        ...
        _b === void 0
          ? void 0
          : _b.call(_a, listNoEventsCCID.current)
      }
      ...
      children: jsxRuntime.jsx('div', {
        ...
        children:
          daysWithEvents.length === 0
            ? listNoEventsCustomComponentFn
              ? jsxRuntime.jsx('div', { 'data-ccid': listNoEventsCCID.current })
              : jsxRuntime.jsx('div', {
                  ...
                  'div',
                  {
                    ...
                    children: [
                      listDayHeaderCustomComponentFn
                        ? jsxRuntime.jsx('div', { 'data-ccid': dayHeaderCCID })
                        : jsxRuntime.jsx('div', {
                            className: 'sx__list-day-header',
                            children: jsxRuntime.jsx('div', {
                              className: 'sx__list-day-date',
                              children: toJSDate(day.date).toLocaleDateString(
                                $app.config.locale.value,
                                {
                                  weekday: 'long',
                                  year: 'numeric',
