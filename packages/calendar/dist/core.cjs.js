...
const getTimeStamp = (
  ...
  if (
    ...
    ((_a = eventTime.start) === null || _a === void 0
      ? void 0
      : _a.toString()) !==
      ((_b = eventTime.end) === null || _b === void 0 ? void 0 : _b.toString())
  ) {
...
function YearsView({ setMonthView }) {
  ...
  hooks.useEffect(() => {
    ...
    const initiallyExpandedYear =
      (_a = document.querySelector('.sx__date-picker__years-view')) === null ||
      _a === void 0
        ? void 0
...
function AppWrapper({ $app }) {
  ...
  hooks.useEffect(() => {
    ...
    if (
      (_a = $app.config.style) === null || _a === void 0 ? void 0 : _a.fullWidth
    )
            ...
            dateFromDateTime(
              (_a =
                ...
                rangeEndMinusOneRange === void 0
                  ? void 0
                  : rangeEndMinusOneRange.toString()) !== null && _a !== void 0
                ? _a
                : ''
        ...
        jsxRuntime.jsxs('div', {
          ...
          children: [
            weekGridDateCustomComponentFn &&
              jsxRuntime.jsx('div', { 'data-ccid': weekGridDateCCIDs[0][idx] }),
            !weekGridDateCustomComponentFn &&
          ...
          jsxRuntime.jsx('div', {
            ...
            children: jsxRuntime.jsxs('div', {
              ...
              children: [
                ...
                jsxRuntime.jsx('div', { className: 'sx__week-header-border' }),
              ],
            }),
          }),
          jsxRuntime.jsxs('div', {
          ...
          jsxRuntime.jsxs('div', {
            ...
            children: [
              ...
              $app.config.plugins.timezoneSelect &&
                ...
                jsxRuntime.jsx($app.config.plugins.timezoneSelect.ComponentFn, {
                  $app: $app,
                }),
...
const createDatePickerState = (config, selectedDateParam) => {
  ...
  const isDark = signals.signal(
    ((_a = config.style) === null || _a === void 0 ? void 0 : _a.dark) || false
  )
...
const createDatePickerConfig = (config, dateSelectionCallback) => {
  ...
  let teleportTo
  if (
    (_a = config.datePicker) === null || _a === void 0 ? void 0 : _a.teleportTo
  ) {
          ...
          isFirstWeek
            ? jsxRuntime.jsx(jsxRuntime.Fragment, {
                children: monthGridDayNameCustomComponent
                  ? jsxRuntime.jsx('div', { 'data-ccid': monthGridDayNameCCID })
                  : jsxRuntime.jsx('div', {
              ...
              return jsxRuntime.jsxs(
                'div',
                {
                  ...
                  children: [
                    ...
                    jsxRuntime.jsx('div', { className: 'sx__list-day-margin' }),
                  ],
                },
                day.date
              )
