...
type CalendarAppWithPlugins<Plugins extends PluginBase<string>[]> = {
  [Name in Plugins[number]['name']]: Extract<
    Plugins[number],
    {
      name: Name
    }
...
declare const createCalendar: <Plugins extends PluginBase<string>[]>(
  config: CalendarConfigExternal,
  plugins?: Plugins
) => CalendarApp & CalendarAppWithPlugins<Plugins>
...
declare function TimeGridDay({
  calendarEvents,
  date,
  backgroundEvents,
}: props$3): import('preact').JSX.Element
...
declare function DateGridDay({
  calendarEvents,
  date,
  backgroundEvents,
}: props$4): import('preact').JSX.Element
type WeekDay$0 = {
  date: string
...
declare const sortEventsForWeekView: (
