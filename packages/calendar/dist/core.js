...
function TimeIcon({ strokeColor }) {
  return jsx(Fragment, {
    children: jsxs('svg', {
      ...
      children: [
        jsx('g', { id: 'SVGRepo_bgCarrier', 'stroke-width': '0' }),
        jsx('g', {
...
function MonthView({ seatYearsView }) {
  ...
  return jsx(Fragment, {
    children: jsxs('div', {
      ...
      children: [
        jsx(MonthViewHeader, { setYearsView: seatYearsView }),
        jsx(DayNames, {}),
        month.map((week) => jsx(MonthViewWeek, { week: week })),
      ],
    }),
  })
}
...
function AppWrapper({ $app }) {
  ...
  return jsx(Fragment, {
    children: jsx('div', {
      ref: elementRef,
      className: classList.join(' '),
      children: jsxs(AppContext$1.Provider, {
        value: $app,
        children: [
          jsx(AppInput, {}),
...
function TimeGridEvent({
  ...
  const customComponentId = useRef$1(getCCID(customComponent, isCopy))
  useEffect(() => {
  ...
  return jsxs('div', {
    ...
    children: [
      backgroundEvents.map((event) =>
        jsx(Fragment, {
          children: jsx(TimeGridBackgroundEvent, {
        ...
        jsxs('div', {
          ...
          children: [
            hourCustomComponentFn &&
              hourCCIDs.length &&
              jsx('div', { 'data-ccid': hourCCIDs[index] }),
            !hourCustomComponentFn &&
              jsx('span', {
        ...
        jsxs('div', {
          ...
          children: [
            weekGridDateCustomComponentFn &&
              jsx('div', { 'data-ccid': weekGridDateCCIDs[0][idx] }),
            !weekGridDateCustomComponentFn &&
              jsxs(Fragment, {
                children: [
                  jsx('div', {
...
function DateGridEvent({ calendarEvent, gridRow, isCopy }) {
  ...
  const customComponentId = useRef$1(
    customComponent
          ...
          jsx('div', {
            ...
            children: jsxs('div', {
              ...
              children: [
                ...
                jsx('div', { className: 'sx__week-header-border' }),
              ],
            }),
          }),
          jsxs('div', {
          ...
          jsxs('div', {
            ...
            children: [
              headerContentLeftPrependId &&
                jsx('div', { 'data-ccid': headerContentLeftPrependId }),
              jsx(TodayButton, {}),
              jsx(ForwardBackwardNavigation, {}),
              jsx(RangeHeading, {}, $app.config.locale.value),
              $app.config.showWeekNumbers.value &&
                isDayOrWeekView &&
                jsx(WeekNumber, {}),
              headerContentLeftAppendId &&
                jsx('div', { 'data-ccid': headerContentLeftAppendId }),
            ],
          }),
          jsxs('div', {
            className: 'sx__calendar-header-content',
            children: [
              headerContentRightPrependId &&
                jsx('div', { 'data-ccid': headerContentRightPrependId }),
              $app.config.plugins.timezoneSelect &&
                $app.config.plugins.timezoneSelect.isEnabled.value &&
                jsx($app.config.plugins.timezoneSelect.ComponentFn, {
                  $app: $app,
                }),
              ...
              jsx(AppWrapper, { $app: datePickerAppSingleton }),
...
function useFetchEvents($app) {
  const hasCalledFetchEventsOnRenderRef = useRef$1(false)
  const initialRangeRef = useRef$1(
  ...
  return jsx(Fragment, {
    children: jsx('div', {
      ...
      children: jsx('div', {
        ...
        children: jsxs(AppContext.Provider, {
          value: $app,
          children: [
            jsx(CalendarHeader, {}),
            jsx('div', {
          ...
          isFirstWeek
            ? jsx(Fragment, {
                children: monthGridDayNameCustomComponent
                  ? jsx('div', { 'data-ccid': monthGridDayNameCCID })
                  : jsx('div', {
            ...
            : null,
          monthGridDateCCID
            ? jsx('div', { 'data-ccid': monthGridDateCCID })
            : jsx('div', {
...
function MonthAgendaEvents({ events }) {
  ...
  return jsx('div', {
    ...
    children: events.length
      ? events.map((event) =>
          jsx(MonthAgendaEvent, { calendarEvent: event }, event.id)
        )
      : jsx('div', {
...
const MonthAgendaWrapper = ({ $app, id }) => {
  ...
  return jsx(AppContext.Provider, {
    ...
    children: jsxs('div', {
      ...
      children: [
        jsx(MonthAgendaDayNames, { week: agendaMonth.weeks[0] }),
        jsx('div', {
            ...
            jsxs('div', {
              ...
              children: [
                ...
                jsx('div', {
                  ...
                  children: jsx(EventTimes, { ...eventInstanceInfo }),
                }),
              ],
            }),
          ],
...
const ListWrapper = ({ $app, id }) => {
   ...
   * */
  const blockOnScrollDayIntoViewCallback = useRef$1(false)
  const blockTimeoutRef = useRef$1(null)
  const lastRangeExpansionRef = useRef$1(null)
  const isExpandingRangeRef = useRef$1(false)
  const scrollPositionBeforeExpansionRef = useRef$1(null)
    ...
    children: jsx('div', {
      ...
      children:
        daysWithEvents.length === 0
          ? listNoEventsCustomComponentFn
            ? jsx('div', { 'data-ccid': listNoEventsCCID.current })
            : jsx('div', {
                ...
                'div',
                {
                  ...
                  children: [
                    listDayHeaderCustomComponentFn
                      ? jsx('div', { 'data-ccid': dayHeaderCCID })
                      : jsx('div', {
                    ...
                    jsx('div', { className: 'sx__list-day-margin' }),
                  ],
                },
                day.date
              )
