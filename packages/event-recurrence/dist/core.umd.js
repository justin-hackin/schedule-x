  ...
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        factory((global.SXEventRecurrence = {})))
  ...
  const monthlyIteratorBymonthday = (dtstart, options) => {
    ...
    return {
      next() {
        ...
        const nextCurrentDateCandidate = addMonths(
          currentDate,
          options.interval
        )
  ...
  class EventsFacadeImpl {
    ...
    set(events) {
      ...
      for (const event of events) {
        ...
        if (rrule) {
          newEventsList.push(
            ...createRecurrencesForEvent(this.$app, newEvent, rrule)
          )
        }
      }
    ...
    update(event) {
      ...
      if (rrule) {
        copiedEvents.push(
          ...createRecurrencesForEvent(this.$app, updatedEvent, rrule)
        )
      }
