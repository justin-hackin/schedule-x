;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(
          ['exports', 'preact/jsx-runtime', 'preact/hooks', '@preact/signals'],
          factory
        )
      : ((global =
...
})(this, function (exports, jsxRuntime, hooks, signals) {
  'use strict'
  ...
  const useIconColors = ($app) => {
    ...
    const iconColor = signals.signal(
  ...
  function EventModal({ $app }) {
    ...
    const { value: calendarEvent } =
      $app.config.plugins.eventModal.calendarEvent
    const [isDisplayed, setIsDisplayed] = hooks.useState(false)
    const customComponent = $app.config._customComponentFns.eventModal
    const [eventWrapperStyle, setEventWrapperStyle] =
      hooks.useState('sx__event-modal')
    const callSetPosition = () => {
      ...
      setPosition(
        ...
        (_b = $app.config.plugins.eventModal) === null || _b === void 0
          ? void 0
          : _b.calendarEventDOMRect.value,
        ((_c = $app.elements.calendarWrapper) === null || _c === void 0
          ? void 0
          : _c.querySelector('.sx__event-modal')
        ).clientHeight
      )
    }
    const scrollListener = () => {
      ...
      $app.config.plugins.eventModal.calendarEventDOMRect.value =
        (_b =
          (_a = $app.config.plugins.eventModal) === null || _a === void 0
            ? void 0
            : _a.calendarEventElement.value) === null || _b === void 0
          ? void 0
    ...
    hooks.useEffect(() => {
      ...
      if (customComponent) {
        customComponent(document.querySelector(`[data-ccid=${modalId}]`), {
          calendarEvent:
            calendarEvent === null || calendarEvent === void 0
              ? void 0
              : calendarEvent._getExternalEvent(),
        })
      } else {
        setEventWrapperStyle(
          eventWrapperStyle.concat(' sx__event-modal-default')
        )
      }
      nextTick(() => {
        callSetPosition()
      ...
      const scrollableAncestors = getScrollableParents(
        ((_a = $app.config.plugins.eventModal) === null || _a === void 0
          ? void 0
          : _a.calendarEventElement.value) || null
      )
        ...
        jsxRuntime.jsx('div', {
          ...
          children:
            ...
            jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                jsxRuntime.jsxs('div', {
                  className: 'sx__has-icon sx__event-modal__title',
                  children: [
                    jsxRuntime.jsx('div', {
                      style: {
                ...
                jsxRuntime.jsxs('div', {
                  className: 'sx__has-icon sx__event-modal__time',
                  children: [
                    jsxRuntime.jsx(TimeIcon, { strokeColor: iconColor.value }),
                    jsxRuntime.jsx('div', {
                ...
                calendarEvent.people &&
                  calendarEvent.people.length &&
                  jsxRuntime.jsxs('div', {
                    className: 'sx__has-icon sx__event-modal__people',
                    children: [
                      jsxRuntime.jsx(UserIcon, {
                        strokeColor: iconColor.value,
                      }),
                ...
                calendarEvent.location &&
                  jsxRuntime.jsxs('div', {
                    className: 'sx__has-icon sx__event-modal__location',
                    children: [
                ...
                calendarEvent.description &&
                  jsxRuntime.jsxs('div', {
                    className: 'sx__has-icon sx__event-modal__description',
                    children: [
                      jsxRuntime.jsx(DescriptionIcon, {
                        strokeColor: iconColor.value,
                      }),
                      calendarEvent.description,
                    ],
