...
declare const addMinutes: (to: string, nMinutes: number) => string;
...
export { definePlugin, deepCloneEvent, concatenatePeople, getTimeStamp, TimeIcon, UserIcon, DescriptionIcon, LocationPinIcon, randomStringId, toTimeString, toDateTimeString, dateStringRegex, toDateString, toJSDate, addDays, addMonths, addMinutes };
export type { CalendarConfigExternal, CalendarEventExternal as CalendarEvent, EventModalPlugin, CalendarEventInternal, View, ViewConfig, CalendarAppSingleton, PluginBase, CustomComponentFns as CustomComponents };
