...
declare function UserIcon({
  strokeColor,
}: props$0): import('preact').JSX.Element
type props$1 = {
  strokeColor: string
}
/**
 ...
 * Author website: https://www.figma.com/@salahelimam
 * */
declare function DescriptionIcon({
  strokeColor,
}: props$1): import('preact').JSX.Element
type props$2 = {
  strokeColor: string
}
/**
 ...
 * */
declare function LocationPinIcon({
  strokeColor,
}: props$2): import('preact').JSX.Element
declare const definePlugin: <Name extends string, T extends PluginBase<string>>(
  name: Name,
  definition: T
) => T & {
  name: Name
}
declare const deepCloneEvent: (
  calendarEvent: CalendarEventInternal,
  $app: CalendarAppSingleton
) => CalendarEventInternal
declare const concatenatePeople: (people: string[]) => string
declare const getTimeStamp: (
  calendarEvent: Partial<CalendarEventInternal>,
...
export type {
  ...
  PluginBase,
  CustomComponentFns as CustomComponents,
  CustomComponentName,
  DateRange,
}
