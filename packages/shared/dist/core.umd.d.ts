 ...
 */
declare const __deprecated__addMinutes: (to: string, nMinutes: number) => string;
 ...
 * */
declare function TimeIcon({ strokeColor }: props): import("preact").JSX.Element;
type props$0 = {
    strokeColor: string;
};
/**
 ...
 * Author website: https://www.figma.com/@salahelimam
 * */
declare function UserIcon({ strokeColor }: props$0): import("preact").JSX.Element;
type props$1 = {
    strokeColor: string;
};
/**
 ...
 * Author website: https://www.figma.com/@salahelimam
 * */
declare function DescriptionIcon({ strokeColor }: props$1): import("preact").JSX.Element;
type props$2 = {
    strokeColor: string;
};
/**
 ...
 * */
declare function LocationPinIcon({ strokeColor }: props$2): import("preact").JSX.Element;
declare const definePlugin: <Name extends string, T extends PluginBase<string>>(name: Name, definition: T) => T & {
    name: Name;
};
declare const deepCloneEvent: (calendarEvent: CalendarEventInternal, $app: CalendarAppSingleton) => CalendarEventInternal;
declare const concatenatePeople: (people: string[]) => string;
declare const getTimeStamp: (calendarEvent: Partial<CalendarEventInternal>, 
// to facilitate testing. In reality, we will always have a full CalendarEventInternal
locale: string, delimiter?: string) => string;
/**
 ...
 * */
declare const randomStringId: () => string;
...
declare const dateStringRegex: RegExp;
declare const toJSDate: (dateTimeSpecification: string) => Date;
export { definePlugin, deepCloneEvent, concatenatePeople, getTimeStamp, TimeIcon, UserIcon, DescriptionIcon, LocationPinIcon, randomStringId, toTimeString, toDateTimeString, dateStringRegex, toDateString, toJSDate, addDays, addMonths, __deprecated__addMinutes as addMinutes };
export type { CalendarConfigExternal, CalendarEventExternal as CalendarEvent, EventModalPlugin, CalendarEventInternal, TimezoneSelectPlugin, View, ViewConfig, CalendarAppSingleton, PluginBase, CustomComponentFns as CustomComponents, CustomComponentName, DateRange };
