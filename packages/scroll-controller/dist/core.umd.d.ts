...
declare class ScrollControllerPlugin implements PluginBase<string> {
    private config;
    name: PluginName;
    private $app;
    private observer;
    private hasScrolledSinceViewRender;
     ...
     * */
    scrollTo(time: string): void;
    private waitUntilGridDayExistsThenScroll;
}
declare const createScrollControllerPlugin: (config?: ScrollControllerConfig) => ScrollControllerPlugin & {
