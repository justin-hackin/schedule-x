;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@preact/signals'))
    : typeof define === 'function' && define.amd
      ? define(['exports', '@preact/signals'], factory)
      : ((global =
          typeof globalThis !== 'undefined' ? globalThis : global || self),
        factory((global.SXScrollController = {}), global.preactSignals))
})(this, function (exports, signals) {
  'use strict'
  ...
  class ScrollControllerPlugin {
    ...
    setInitialScroll($app) {
      const gridDay =
        $app.elements.calendarWrapper.querySelector('.sx__time-grid-day')
      ...
      signals.effect(() => {
        ...
        if (
          InternalViewName.Day ===
            ((_a = this.$app) === null || _a === void 0
              ? void 0
              : _a.calendarState.view.value) ||
          InternalViewName.Week ===
            ((_b = this.$app) === null || _b === void 0
              ? void 0
              : _b.calendarState.view.value)
        ) {
    ...
    scrollTo(time) {
      ...
      const viewContainer = $app.elements.calendarWrapper.querySelector(
        '.sx__view-container'
      )
        ...
        mutations.forEach((mutation) => {
          ...
          const gridDayExists =
            (_b =
              (_a = this.$app) === null || _a === void 0
                ? void 0
                : _a.elements.calendarWrapper) === null || _b === void 0
              ? void 0
              : _b.querySelector('.sx__time-grid-day')
          if (
            ...
            ;(_c = this.observer) === null || _c === void 0
              ? void 0
              : _c.disconnect()
          }
        })
