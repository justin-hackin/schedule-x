...
declare class IcalendarPluginImpl implements PluginBase<string> {
    private options;
    name: string;
    private $app;
    private readonly source;
    constructor(options: ICalendarPluginOptions);
    beforeRender($app: CalendarAppSingleton): void;
    /**
     ...
     * ```
     * */
    between(dateRangeStart: DateRangeBoundary, dateRangeEnd: DateRangeBoundary): void;
    private parseIcalendarSourceForDatesBetween;
    private icalOccurrenceToSXEvent;
    private icalEventToSXEvent;
    private toTemporalRange;
    private icalDateToTemporal;
    private normalizeAllDayRange;
    private normalizeMidnightTimedRange;
    private rangeBoundaryToDate;
}
declare const createIcalendarPlugin: (options: ICalendarPluginOptions) => IcalendarPluginImpl & {
