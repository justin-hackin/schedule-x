(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SXICalendar = {}));
  ...
  */
  ...
  class IcalExpander {
    constructor(opts) {
      ...
      this.events = this.component.getAllSubcomponents('vevent').map(vevent => new ICALmodule.Event(vevent));
  ...
  class IcalendarPluginImpl {
      constructor(options) {
          ...
          Object.defineProperty(this, "icalOccurrenceToSXEvent", {
              ...
              writable: true,
              value: (occurrence) => {
                  const { start, end } = this.toTemporalRange(occurrence.startDate, occurrence.endDate);
      ...
      beforeRender($app) {
          var _a, _b;
          this.$app = $app;
          const dateRangeStart = (_a = $app.calendarState.range.value) === null || _a === void 0 ? void 0 : _a.start;
          const dateRangeEnd = (_b = $app.calendarState.range.value) === null || _b === void 0 ? void 0 : _b.end;
      ...
      toTemporalRange(start, end) {
          ...
          const normalizedAllDayRange = this.normalizeAllDayRange(startTemporal, endTemporal);
