;(function (global, factory) {
...
})(this, function (exports, preact, jsxRuntime, compat, hooks, signals) {
  'use strict'
      ...
      children: jsxRuntime.jsxs('div', {
        ...
        children: [
          jsxRuntime.jsx('label', {
            htmlFor: inputId,
            className: 'sx__time-input-label',
            children:
              (_a = $app.config.label.value) !== null && _a !== void 0
                ? _a
                : $app.translate('Time'),
          }),
  ...
  function TimeInput({
    ...
    compat.useEffect(() => {
      ...
      if (
        ...
        ;(_a = nextTabIndexRef.current) === null || _a === void 0
          ? void 0
          : _a.focus()
  ...
  function AppPopup() {
    ...
    const [hoursValue, setHoursValue] = hooks.useState(
    ...
    const getFixedPositionStyles = () => {
      var _a, _b, _c
      const inputRect =
        (_a = $app.timePickerState.inputWrapperElement.value) === null ||
        _a === void 0
          ? void 0
      ...
      return {
        top: (
          (_b = $app.config.placement.value) === null || _b === void 0
            ? void 0
            : _b.includes('bottom')
        )
        ...
        left: (
          (_c = $app.config.placement.value) === null || _c === void 0
            ? void 0
            : _c.includes('start')
        )
          ? inputRect.x
    ...
    return jsxRuntime.jsxs('div', {
      ...
      children: [
        jsxRuntime.jsx('div', {
          className: 'sx__time-picker-popup-label',
          children: $app.translate('Select time'),
        }),
        jsxRuntime.jsxs('div', {
          className: 'sx__time-picker-time-inputs',
          children: [
            ...
            jsxRuntime.jsx('span', {
              className: 'sx__time-picker-colon',
              children: ':',
            }),
            jsxRuntime.jsx(TimeInput, {
            ...
            $app.config.is12Hour.value &&
              jsxRuntime.jsxs('div', {
                className: 'sx__time-picker-12-hour-switches',
                children: [
                  jsxRuntime.jsx('button', {
                    ...
                    children: $app.translate('AM'),
                  }),
                  jsxRuntime.jsx('button', {
                    type: 'button',
                    className: `sx__button sx__time-picker-12-hour-switch${!$app.timePickerState.isAM.value ? ' is-selected' : ''}`,
                    onClick: () => ($app.timePickerState.isAM.value = false),
                    children: $app.translate('PM'),
                  }),
                ],
              }),
          ],
        ...
        jsxRuntime.jsxs('div', {
          class: 'sx__time-picker-actions',
          children: [
            jsxRuntime.jsx('button', {
              type: 'button',
              class:
                'sx__button sx__time-picker-action sx__ripple sx__button-cancel',
              onClick: () => ($app.timePickerState.isOpen.value = false),
              children: $app.translate('Cancel'),
            }),
            jsxRuntime.jsx('button', {
              ref: OKButtonRef,
              type: 'button',
              class:
                'sx__button sx__time-picker-action sx__ripple sx__button-accept',
              onClick: handleAccept,
              children: $app.translate('OK'),
            }),
          ],
        }),
      ],
  ...
  function TimePickerWrapper({ $app }) {
    ...
    if ($app.config.teleportTo.value) {
      AppPopupJSX = compat.createPortal(
        AppPopupJSX,
        $app.config.teleportTo.value
      )
    }
    return jsxRuntime.jsx(jsxRuntime.Fragment, {
  ...
  class TimePickerApp {
    ...
    render(el) {
      preact.render(
        preact.createElement(TimePickerWrapper, {
          $app: this.$app,
        }),
        el
      )
  ...
  const getTimePickerState = (config, is12HourClock) => {
    var _a
    const currentTime = signals.signal(
      (_a = config.initialValue) !== null && _a !== void 0 ? _a : '00:00'
    )
  ...
  const createTimePickerAppContext = (config = {}, translateFn) => {
    ...
    return {
      config: {
        onEscapeKeyDown: signals.signal(
          (_a = config.onEscapeKeyDown) !== null && _a !== void 0
            ? _a
            : undefined
        ),
        dark: signals.signal(
          (_b = config.dark) !== null && _b !== void 0 ? _b : false
        ),
        placement: signals.signal(
          (_c = config.placement) !== null && _c !== void 0
            ? _c
            : 'bottom-start'
        ),
        teleportTo: signals.signal(
          (_d = config.teleportTo) !== null && _d !== void 0 ? _d : null
        ),
        label: signals.signal(
          (_e = config.label) !== null && _e !== void 0 ? _e : null
        ),
        is12Hour: signals.signal(
          (_f = config.is12Hour) !== null && _f !== void 0 ? _f : false
        ),
        name: signals.signal(
          (_g = config.name) !== null && _g !== void 0 ? _g : ''
        ),
      },
      timePickerState: getTimePickerState(
        config,
        (_h = config.is12Hour) !== null && _h !== void 0 ? _h : false
      ),
