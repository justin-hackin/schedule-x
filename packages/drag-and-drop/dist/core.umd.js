;(function (global, factory) {
  ...
  const updateRecurringEvent = ($app, eventCopy, startPreDrag) => {
    var _a
    ;(_a = $app.config.plugins.eventRecurrence) === null || _a === void 0
      ? void 0
      : _a.updateRecurrenceDND(eventCopy.id, startPreDrag, eventCopy.start)
  }
  ...
  const getTimePointsPerPixel = ($app) => {
    return (
      $app.config.timePointsPerDay / $app.config.weekOptions.value.gridHeight
    )
  }
  ...
  class TimeGridDragHandlerImpl {
    ...
    handleHorizontalMouseOrTouchMove(totalDaysDiff) {
      ...
      const newEndDate = addDays(
        dateFromDateTime(this.eventCopy.end),
        diffToAdd
      )
      ...
      if (newStart < this.$app.calendarState.range.value.start) return
      if (newEnd > this.$app.calendarState.range.value.end) return
  ...
  const getDateGridEventCopy = ($app, eventCopy) => {
    return $app.elements.calendarWrapper.querySelector(
  ...
  class DateGridDragHandlerImpl {
    constructor($app, eventCoordinates, eventCopy, updateCopy) {
      ...
      Object.defineProperty(this, 'handleMouseOrTouchMove', {
        ...
        value: (uiEvent) => {
          ...
          const newStartIsInWeek =
            newStartDate >= this.rangeStartDate &&
            newStartDate <= this.rangeEndDate
      ...
      this.rangeStartDate = dateFromDateTime(
        this.$app.calendarState.range.value.start
      )
  ...
  class MonthGridDragHandlerImpl {
    constructor(calendarEvent, $app) {
      ...
      Object.defineProperty(this, 'setCalendarEventPointerEventsTo', {
        ...
        value: (pointerEvents) => {
          var _a
          ;((_a = this.$app.elements.calendarWrapper) === null || _a === void 0
            ? void 0
            : _a.querySelectorAll('.sx__event')
          ).forEach((el) => {
      ...
      Object.defineProperty(this, 'updateCalendarEvent', {
        ...
        value: () => {
          ...
          const diffOldDateAndNewDate = calculateDaysDifference(
            ...
            dateFromDateTime(this.currentDragoverDate)
          )
      ...
      this.allDayElements = $app.elements.calendarWrapper.querySelectorAll(
